...
{
    class FortigateException : ApplicationException
    {
        public FortigateException(string message) : base(message)
        { }

        public FortigateException(string message, Exception ex) : base(message, ex)
        { }
